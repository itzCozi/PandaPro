...
public:
    ...
    // Project folders: user-defined named groups of project file paths
    struct ProjectFolder {
        std::string              name;
        std::vector<std::string> paths;
    };
    std::vector<ProjectFolder> get_project_folders() const;
    void set_project_folders(const std::vector<ProjectFolder>& folders);
